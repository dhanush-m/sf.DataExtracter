...
// Update the /api/extract/:type endpoint to use the new fetchContentAssets function
  ...
  try {
    ...
    switch (type) {
      ...
      case 'journeys':
        ...
        break;
      case 'content-assets':  // This line now correctly handles 'content-assets'
    ...
    // If the data is nested within an 'items' property, extract it
    const finalData = responseData.items ? responseData.items : responseData;
